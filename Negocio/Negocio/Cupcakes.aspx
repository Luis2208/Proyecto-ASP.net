<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="Cupcakes.aspx.cs" Inherits="Negocio.Cupcakes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="margin-right: 1%">
                ...
                <asp:DataList ID="DataList1" runat="server" CellPadding="4" RepeatColumns="3"  ForeColor="#333333" Width="100%" OnItemCommand="DataList1_ItemCommand" >
                    ...
                    <ItemTemplate>
                        ...
                        <div class="auto-style6">
                            ...
                            <br />
                            <br />
                            <asp:Button ID="ButtonAGREGAR" runat="server" Text="AGREGAR AL CARRITO" CommandName="SELECCIONAR" />
                        </div>
