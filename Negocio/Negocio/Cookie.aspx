<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="Cookie.aspx.cs" Inherits="Negocio.Cookie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 100%">
        ...
        <div style="margin-right: 1%">
                ...
                <asp:DataList ID="DataList1" runat="server" DataKeyField="CodigoProducto" CellPadding="4" RepeatColumns="3"  ForeColor="#333333" Width="100%" OnItemCommand="DataList1_ItemCommand" >
                    ...
                    <ItemTemplate>
                        ...
                        <div class="auto-style6">
                            ...
                            <br />
                            <asp:Button ID="ButtonAG" runat="server" Text="AGREGAR AL CARRITO" CommandName="SELECCIONAR" />
                            <br />
                        </div>
